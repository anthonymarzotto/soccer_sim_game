...
describe('PersistenceService', () => {
  ...
  it('should load and save league using normalized persistence', async () => {
    const league = { teams: [], schedule: [], currentWeek: 1, currentSeasonYear: 2026, transferListings: [], transferOffers: [] };
  ...
  it('should block mutating writes and throw when persisted schema version mismatches', async () => {
    ...
    await expect(
      service.saveLeague({ teams: [], schedule: [], currentWeek: 1, currentSeasonYear: 2026, transferListings: [], transferOffers: [] })
    ).rejects.toThrow('Database write blocked: Persisted data schema version mismatch.');
