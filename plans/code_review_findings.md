...
### 6. ~~`streaks` in `all` Mode Iterates All Teams × All Matches for Each Team (O(T×M))~~ [FIXED]
* **Location:** [season-summary.ts L295–310](file:///C:/Repos/soccer_sim_game/src/app/pages/season-summary/season-summary.ts#L295-L310) (now L435-451)
